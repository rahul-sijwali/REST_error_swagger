...
public class SwaggerDocsConfig {
	...
	public Docket createDocket() {
		return new Docket(DocumentationType.SWAGGER_2).// UI Screen type
				...
				apis(RequestHandlerSelectors.basePackage("in.rahul.restcontroller"))// base packages for// RestController
	...
	private ApiInfo getApiInfo() {
		Contact contact = new Contact("rahul", "https://www.linkedin.com/in/rahul-sijwali/", "rahul_sijwali@iitg.ac.in");
